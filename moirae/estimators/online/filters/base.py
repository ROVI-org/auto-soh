...
class ModelWrapper():
    ...
    def __init__(self,
        ...
        # TODO (wardlt): Figure out if we want to modify such the conversions are applied the base class. Will reduce opportunities for mistakes in subclasses
        #  General strategy would be to apply converters in `predict_measurement` and `update_hidden_states` in base class, and have the subclass-specific
